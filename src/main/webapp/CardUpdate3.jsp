...
<%
  ...
  try {
    ...
    if (conn != null) {
      String query = "UPDATE card_tb SET  card_co = ?, card_num = ?, cvc_num = ? WHERE userid = ?";
      pstmt = conn.prepareStatement(query);

      pstmt.setString(1, request.getParameter("card_co"));
      pstmt.setString(2, request.getParameter("card_num"));
      pstmt.setString(3, request.getParameter("cvc_num"));
