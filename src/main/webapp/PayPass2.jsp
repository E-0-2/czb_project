...
<div class="button-container">
  <button><a href="PayPassMethod.jsp">PayPass 등록</a></button>
  <button><a href="PayPassUpdate.jsp">PayPass 수정</a></button>
  <button><a href="PayPassDelete.jsp">PayPass 삭제</a></button>
  <button><a href="PayPassCheck.jsp">PayPass 확인</a></button>
</div>
<%
} else {
%>
